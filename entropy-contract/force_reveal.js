...
async function main() {
  ...
  // Support mainnet and testnet via NETWORK env var (default: mainnet)
  const network = process.env.NETWORK || "mainnet";
  const isMainnet = network === "mainnet";
  const rpc = isMainnet ? "https://rpc.mainnet.x1.xyz" : "https://rpc.testnet.x1.xyz";
  ...
  console.log(`Network: ${network.toUpperCase()} | RPC: ${rpc}`);
